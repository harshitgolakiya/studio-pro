...
MEDIA_FORMAT_CAPABILITIES: dict[str, dict[str, Any]] = {
    "Video: MP4": {"category": "Video", "description": "Universal H.264 video with AAC audio, hardware accelerated where available.", "badges": ("Universal", "Hardware GPU", "High definition", "Metadata")},
    "Video: WebM": {"category": "Video", "description": "VP9 video with Opus audio for modern web streaming.", "badges": ("Web streaming", "Alpha transparency", "Modern VP9", "Open format")},
    "Video -> Animated WebP": {"category": "Video", "description": "Turn a clip into a compact animated WebP.", "badges": ("Animation", "Alpha transparency", "Compact web", "Muted")},
    "Video -> GIF": {"category": "Video", "description": "Palette-optimized animated GIF from a clip.", "badges": ("Animation", "Universal playback", "Palette-optimized", "Muted")},
    "Video -> Audio (MP3)": {"category": "Audio", "description": "Extract the soundtrack as MP3.", "badges": ("Audio soundtrack", "Universal MP3")},
    "Extract Audio: MP3": {"category": "Audio", "description": "Extract the soundtrack as MP3.", "badges": ("Audio soundtrack", "Universal MP3")},
    "Extract Audio: AAC": {"category": "Audio", "description": "Extract the soundtrack as AAC in an M4A container.", "badges": ("Audio soundtrack", "Apple AAC", "High quality")},
    "Extract Audio: Opus": {"category": "Audio", "description": "Extract the soundtrack as small, high-quality Opus.", "badges": ("Audio soundtrack", "Opus audio", "High efficiency")},
    "Extract Audio: WAV": {"category": "Audio", "description": "Extract the soundtrack as uncompressed PCM.", "badges": ("Audio soundtrack", "Lossless WAV", "Studio master")},
    "Audio: MP3": {"category": "Audio", "description": "Universal audio for players, phones, and streaming.", "badges": ("Universal audio", "High compatibility", "Metadata")},
    "Audio: AAC": {"category": "Audio", "description": "Efficient high-quality audio favoured by Apple devices.", "badges": ("High fidelity", "Apple standard", "Metadata")},
    "Audio: Opus": {"category": "Audio", "description": "Best quality per kilobit for voice and music on the web.", "badges": ("High efficiency", "Crystal voice & music", "Open format")},
